...
public class Main {
    ...
    private static boolean isInvalidStn(String stnName){
        ...
        String[] Sinlim = {"관악산", "서울대벤처타운", "서원", "신림", "당곡", "보라매병원", "보라매공원", "서울지방병무청", "샛강"}; // 신림선 역 중 환승역(보라매, 대방) 제외
    ...
    public static void setStnCode(){
        for(int i = 0; i < 19; i++){
            ...
            LineNameCode.put("인천국제공항철도", "1065");
            LineNameCode.put("공항철도", "1065");
            LineNameCode.put("공철", "1065");
            LineNameCode.put("공항", "1065");
            ...
            LineNameCode.put("신분당", "1077");
            LineNameCode.put("우이신설선", "1092");
            LineNameCode.put("우이신설", "1092");
            LineNameCode.put("서해선", "1093");
            LineNameCode.put("서해", "1093");
            LineNameCode.put("경강선", "1081");
            LineNameCode.put("경강", "1081");
    ...
    public static void main(String[] args) throws IOException{
        ...
        while(true){
            System.out.println("\n***** 서울 지하철 실시간 도착정보 안내 프로그램 *****\n" +
                    ...
                    "역명을 입력하신 후에 노선을 입력해주시면 찾으시는 역의 실시간 열차 도착 정보를 상행과 하행 각각 최대 3개씩 출력해 드립니다.\n" +
            ...
            System.out.print("\n***** 찾고자 하는 역명('역' 제외 이름만)을 입력해주세요. *****\n" +
                    ...
                    "===[미지원 구간 안내]===\n" +
                    " * 진접선 (진접~별내별가람)\n" +
                    " * 신림선 (샛강~관악산) !! 환승역은 신림선을 제외한 노선만 확인 가능합니다.\n" +
                    " * 의정부경전철 (탑석~발곡) !! 회룡역은 1호선 정보 확인만 가능합니다.\n" +
            ...
            String apiUrl = "http://swopenapi.seoul.go.kr/api/subway/" + metroAPIKey + "/json/realtimeStationArrival/0/29/" + stationInput;
            // -> 요청을 보낼 API 키 조합
